        ...
        >
          ...
          >
            <TouchableOpacity
              ...
              onPress={() => { navigation.push({ pathname: '/main/tabs/profile/editProfile', params: { type: 'name', value: userInfoQuery.data?.name } }) }}
            >
              <Text
                style={{
                  fontFamily: 'Inter',
            ...
            <TouchableOpacity
              ...
              onPress={() => { navigation.push({ pathname: '/main/tabs/profile/editProfile', params: { type: 'email', value: userInfoQuery.data?.email } }) }}
            >
              <Text
                style={{
                  fontFamily: 'Inter',
            ...
            <TouchableOpacity
              ...
              onPress={() => { navigation.push({ pathname: '/main/tabs/profile/changePassword' }) }}
            >
              <Text
                style={{
                  fontFamily: 'Inter',
